...
func AddRouteForSoftwareController(r *gin.RouterGroup, middleware gin.HandlerFunc, repo app.SoftwarePkgService) {
	ctl := SoftwareController{
		repo: repo,
	}

	r.POST("/v1/add-software", middleware, ctl.AddSoftware)
